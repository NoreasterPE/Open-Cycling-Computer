...
class mma8451():
	...
	#def set_up_gpio(self):
		...
		GPIO.setup(self.SCL, GPIO.OUT, initial=GPIO.HIGH, pull_up_down=GPIO.PUD_UP)
		GPIO.setup(self.SDA, GPIO.OUT, initial=GPIO.HIGH, pull_up_down=GPIO.PUD_UP)
		#i2c start
		...
		GPIO.setup(self.SCL, GPIO.OUT, initial=GPIO.LOW, pull_up_down=GPIO.PUD_UP)
		GPIO.setup(self.SDA, GPIO.OUT, initial=GPIO.LOW, pull_up_down=GPIO.PUD_UP)
